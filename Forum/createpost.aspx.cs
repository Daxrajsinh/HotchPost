        ...
        void Addpost()
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        cmd = new SqlCommand("INSERT INTO [dbo].[Post](posttitle,postcontent,postdate,userid,PostPic) values(@posttitle,@postcontent,@postdate,@userid,@postpic)", con);
                        cmd.Parameters.AddWithValue("@postpic", PostPicBytes);
                        PostPicBytes = filePostPic.FileBytes;
                    } else
                    {
                        cmd = new SqlCommand("INSERT INTO [dbo].[Post](posttitle,postcontent,postdate,userid) values(@posttitle,@postcontent,@postdate,@userid)", con);
                    }
